interface FollowUsInterface {
  t: (key: string) => string;
}

export default function FollowUsIcons({ t }: FollowUsInterface) {
  return (
    <div className="container mx-auto px-6">
      <div className="text-center">
        ...
        <p className="text-gray-400 mb-8">{t("contact.follow_description")}</p>
        ...
        <div className="flex justify-center items-center gap-2 mb-8 group-hover-parent">
          ...
          >
            <svg
              className="w-8 h-8 text-blue-600 group-hover:text-blue-800 transition-colors"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
